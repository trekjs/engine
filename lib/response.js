...
const { getLength, send, writable } = require('./util')
...
module.exports = class Response {
  ...
  set body (val) {
    ...
    return send(this.raw, val, this.onError)
  }
  ...
  get length () {
    ...
    if (len) return ~~len
    return getLength(this[SYMBOL_BODY])
  }
  ...
  send (code, body = null) {
    const raw = this.raw
    raw.statusCode = code
    return send(raw, body, this.onError)
  }
